      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-6 col-xl-2">
            <h1 class="mb-0 site-logo"><a href="index.php"><img src="assets/images/logov2land.png" alt="logo" style="width:100%"></a></h1>
          </div>
          ...
          <div class="col-12 col-md-10 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li><a href="https://bappeda.cilacapkab.go.id/" class="nav-link">Website Dinas</a></li>
                ...
                <li class="social"><a href="https://www.instagram.com/bappeda_clp/" class="nav-link"><span class="icon-instagram"></span></a></li>
              </ul>
            </nav>
          </div>

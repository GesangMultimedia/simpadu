...
<html lang="en">
  <head>
    ...
    <title>SIMPADU - BAPPEDA CILACAP</title>
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-6 col-xl-2">
            <h1 class="mb-0 site-logo"><a href="index.php"><img src="./assets/images/logov2land.png" alt="logo" style="width: 200px"></h1>
          </div>
            ...
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li class="has-children">
                  <a href="#about-section" class="nav-link">Data</a>
                  <ul class="dropdown">
                    <li><a href="pertanian.php" class="nav-link">Sektor Pertanian</a></li>
                    <li><a href="perikanan.php" class="nav-link">Sektor Perikanan</a></li>
                    <li><a href="luas_lahan.php" class="nav-link">Luas lahan</a></li>
                  </ul>
                </li>          
                <li><a href="aplikasi/index.php" class="nav-link">Data Master</a></li>
                <li><a href="https://bappeda.cilacapkab.go.id/" target="_blank" class="nav-link">Website Dinas</a></li>
                <li class="social"><a href="https://www.facebook.com/pages/Bapeda-Kabupaten-Cilacap/" target="_blank" class="nav-link"><span class="icon-facebook"></span></a></li>
                <li class="social"><a href="https://twitter.com/bappeda_clp" target="_blank" class="nav-link"><span class="icon-twitter"></span></a></li>
                <li class="social"><a href="https://www.instagram.com/bappeda_clp/" target="_blank" class="nav-link"><span class="icon-instagram"></span></a></li>
              </ul>
            </nav>
          </div>

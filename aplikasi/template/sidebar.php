    ...
    <div class="page-wrapper chiller-theme sidebar-bg bg5 toggled">
        <nav id="sidebar" class="sidebar-wrapper">
            <div class="sidebar-content">
                ...
                <!-- sidebar-menu  -->
                <div class=" sidebar-item sidebar-menu text-white">
                    <ul>                        
                        <li>
                            <a href="index.php">
                                <i class="fa fa-home"></i>
                                <span class="menu-text text-white">Beranda</span>
                            </a>
                        </li>
                        ...
                        <li class="sidebar-dropdown">
                            ...
                            <div class="sidebar-submenu">
                                <ul>
                                    <li>
                                        <a href="master_data_pertanian.php"><i class="fas fa-seedling"></i> Data Pertanian</a>
                                    </li>
                                    <li>
